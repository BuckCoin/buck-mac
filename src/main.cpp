...
#if defined(NDEBUG)
# error "Buck cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Buck Signed Message:\n";
...
bool CheckBlockHeader(const CBlockHeader& block, CValidationState& state, bool fCheckPOW)
{
    ...
    // starting at height 210000, decrease to 30 minute window to decrease effectiveness of timewarp attack.
